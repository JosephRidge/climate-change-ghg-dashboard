...
<template> 
  ...
  <div class=" mt-6">
    ...
    <p class="mb-8 text-green-600 px-3 ">
        The data targets <span class="hover:underline hover:underline-offset-4 font-bold">47 regions</span> computing the <span class="hover:underline hover:underline-offset-4 font-bold">cummulative</span> tree cover loss per ha from <span class="hover:underline hover:underline-offset-4 font-bold">2001 to 2022</span>. The regions are: 
    <div class="grid grid-cols-5 ">  <span class=" pl-5 bg-green-100 rounded-lg px-1 py-1 mr-1 my-2" v-for="location in locations" :key="location">
      {{ location }}  </span></div>
    </p>
  </div>
</template>
